...
<template>
    <div class="the-upload-image">
        <div :style="{ 'width': width }" class="the-upload-content">
            <div v-if="src" class="the-upload-image-box">
                <img :src="src" :style="{ 'height': autoHeight ? undefined : height }" class="image">
                <div class="remove fvc">
                    <Icon v-if="!disabled" class="cursor-pointer" name="ep:delete" size="28px" @click="removeImg()"/>
                </div>
            </div>
            <div v-else :style="{ 'height': height }" class="the-upload-box fvc">
