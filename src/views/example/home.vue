...
<template>
    <div class="page-home">
        ...
        <div class="options-box mb-[40px]">
            <CheckBox v-model="layoutInfo.showSidebarLogo" class="mb-[20px]" label="显示侧边栏logo" />
            <CheckBox v-model="layoutInfo.showTagList" class="mb-[20px]" label="显示历史记录标签" />
            <CheckBox v-model="layoutInfo.showSidebar" class="mb-[20px]" label="侧边栏展开" />
            <CheckBox :model-value="layoutInfo.layoutMode === 'full-header'" label="顶部填满" @change="onMode()" />
        </div>
